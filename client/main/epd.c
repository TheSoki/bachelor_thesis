...
#define PIN_SPI_SCK_NUM GPIO_NUM_13   // SCK (Serial Clock)
#define PIN_SPI_DIN_NUM GPIO_NUM_14   // MOSI (Master Out Slave In)
#define PIN_SPI_CS_NUM GPIO_NUM_15    // CS (Chip Select)
#define PIN_SPI_BUSY_NUM GPIO_NUM_25  // HRDY (Hardware Ready)
#define PIN_SPI_RST_NUM GPIO_NUM_26   // RST (Reset)
#define PIN_SPI_DC_NUM GPIO_NUM_27    // Data/Command
